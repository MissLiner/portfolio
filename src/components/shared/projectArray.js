...
export const projectArray = [
  ...
  { name: "Tic-Tac-Toe",
    ...
    focus: ["Factory Functions", "Module Pattern"],
    summary: "Another early project which introduced me to modules and closures. After practicing my early JS skills, I added a design crafted to appeal to my daughter (and other grade-school-aged children).",
