    ...
    <Wrapper>
      <Title>My Story</Title>
        <Unit>
          ...
          <Text>
            I'm new web developer and an experienced collaborator. I approach every challenge with curiosity and an analytical mindset, uncovering patterns, and tracing them to develop solutions. I love problem-solving; whether structuring a new project or chasing down an erascible bug, I'm on the case.
          </Text>
        </Unit>
        <Unit>
          <Topic>
        ...
        <Unit>
          ...
          <Text>
            Web design affects our experience of the world, so I also spent time on color, fonts, layout, and learning <u>Illustrator</u>. I care deeply about responsive designs that make our time online useful, smooth, and sometimes even joyous! I've designed several websites, along with icons, logos, and other images in Illustrator.
          </Text>
        </Unit>
    </Wrapper>
  )
